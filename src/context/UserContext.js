...
export const UserStore = (props) => {
  ...
  const autoRenewTokenAfterMillisec = (milliSec) => {
    ...
    axios
      .post(
        "https://securetoken.googleapis.com/v1/token?key=AIzaSyB22Ov2x0bkJHP-ydsuA8ra9vnw5DXEmAg",
        {
  ...
  const loginUser = (email, password) => {
    ...
    axios
      .post(
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyB22Ov2x0bkJHP-ydsuA8ra9vnw5DXEmAg",
        data
      )
      .then((result) => {
